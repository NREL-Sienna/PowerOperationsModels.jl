...
!!! note "`StaticBranchBounds` ≡ `StaticBranch` on the AC networks"
    ...
    `StaticBranchBounds` is not adding a mathematically new limit; it additionally sets an
    explicit JuMP variable bound (`min_max_flow_limits`) on the directional flow variables
    when they are created. The two formulations are mathematically equivalent
...
|:---------------------------------------------------------------------------- |:----------------------------------------------------------------------------------------------------------- |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ACPNetworkModel`, `ACRNetworkModel`, `LPACCNetworkModel`, `IVRNetworkModel` | `pft² + qft² ≤ rating²` quadratic row only (no variable bounds)                                             | Same quadratic row **plus** explicit JuMP bounds on the four directional flow variables (`branch_variable_bounds`)                                                                                                                                                          |
...
| `NFANetworkModel`                                                            | `FlowRateConstraint` (`"lb"`/`"ub"`) rows on `FlowActivePowerVariable`                                      | Hard JuMP bounds only (`branch_variable_bounds`); no constraint row exists to relax                                                                                                                                                                                         |
