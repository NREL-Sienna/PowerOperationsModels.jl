function get_affected_values(ff::IOM.AbstractAffectFeedforward)
...
function attach_feedforward!(
    model::DeviceModel,
    ff::T,
) where {T <: IOM.AbstractAffectFeedforward}
...
function get_component_type(ff::IOM.AbstractAffectFeedforward)
    return get_component_type(get_optimization_container_key(ff))
end

function get_feedforward_meta(ff::IOM.AbstractAffectFeedforward)
...
"""
struct UpperBoundFeedforward <: IOM.AbstractAffectFeedforward
...
"""
struct LowerBoundFeedforward <: IOM.AbstractAffectFeedforward
    optimization_container_key::OptimizationContainerKey
...
"""
struct SemiContinuousFeedforward <: IOM.AbstractAffectFeedforward
    optimization_container_key::OptimizationContainerKey
    affected_values::Vector{<:OptimizationContainerKey}
...
"""
struct FixValueFeedforward <: IOM.AbstractAffectFeedforward
    optimization_container_key::OptimizationContainerKey
    affected_values::Vector
